...
為 Instagram 與 Threads 貼文設計的 Codex skill。丟進截圖、貼文文案或情境描述後，它會生成自然、有梗、可直接複製的台灣繁中留言與 hashtag。
...
- 每次會額外給 5–10 個「適合使用的 hashtag」，可直接用在引用或轉發
...
留言後會獨立列出「適合使用的 hashtag」。這些 hashtag 會對應貼文主題、情境、地點、活動或社群，適合複製到引用或轉發貼文中；不會亂編品牌、地點或活動名稱。

```
適合使用的 hashtag
#台北美食 #週末去哪裡 #咖啡日常 #探店分享 #TaipeiCafe
```

## 呼叫方式

```
Use $social-comment-writer to create natural Taiwanese Traditional Chinese replies and relevant hashtags for this social post.
```
